<template>
  <div id="app" class="container">
    ...
    <footer class="container-fluid footer text-left mt-3">
      <p class="mr-auto">
        Developed by:
        <strong>Talon Smart</strong>
      </p>
      <div style="float: right">
        <a href="mailto:talonsmart2000@gmail.com" style="margin-right: 10px">
          <i
        ...
        <a
          href="https://github.com/talonsmart"
          target="_blank"
        ...
        <a
          href="https://www.linkedin.com/in/talonsmart/"
          target="_blank"
          style="margin-right: 10px"
        >
          <i
