      ...
      <div class="modal-content text-center">
        <div class="modal-header">
          <h4 class="modal-title" style="margin: 0 auto">
            More About
            <span style="color:crimson">talonsmart</span>
          </h4>
        </div>
        <div class="modal-body">
          <img
            ...
            class="avatar"
          >
          <h3 class="media-heading">Talon Smart</h3>
          <h6>
            <strong>talonsmart2000@gmail.com</strong>
          </h6>
          <h6>
            <a href="https://talonsmart.github.io/" target="_blank">talonsmart.github.io</a>
            <strong></strong>
          </h6>
